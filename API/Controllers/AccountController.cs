...
namespace API.Controllers
{
    ...
    public class AccountController: ControllerBase
    {
        ...
        public async Task<ActionResult<AuthResponseDto>> RefreshToken(TokenDto tokenDto)
        {
            ...
            if(principle is null || user is null || user.RefreshToken !=tokenDto.RefreshToken||user.RefreshTokenExpiryTime <= DateTime.UtcNow)
        ...
        private ClaimsPrincipal? GetPrincipalFromExpiredToken(string token)
        {
            ...
            var principle=tokenHandler.ValidateToken(token,tokenParameters, out SecurityToken securityToken);
